...
comp_infos, ctag_ctag, ctag_nctag, nctag_nctag, ctag_position, comp_id_name_dict = pipline.data_loader()
...
def multi_process_rank(comp_name, graph=graph, weights=(0.5, 0.4, 0.1), response_num=None, tag_link_filters=(0.0, 0.3, 0.3), process_num=8):
